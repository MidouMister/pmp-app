...
const CompanyDetails = ({ data, noCard = false }: Props) => {
  ...
  const formContent = (
    <>
      ...
      {data?.id && (
        <div className="mt-8 rounded-xl border border-destructive/20 bg-destructive/10 p-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Actions irréversibles pour votre entreprise
                </p>
              </div>
            </div>
            ...
            <div className="rounded-lg border border-destructive/20 bg-background p-4">
              <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Cette action supprimera définitivement l&apos;entreprise et
